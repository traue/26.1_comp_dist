...
Construir um **chat em tempo real** onde múltiplos clientes se conectam a um servidor e trocam mensagens livremente entre si. Qualquer mensagem enviada por um cliente é retransmitida a **todos clientes** conectados.
...
O cliente também tem duas fontes de entada simultâneas:
